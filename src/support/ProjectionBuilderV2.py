...
class ProjectionBuilder():
    ...
    def __init__(self, df: pd.DataFrame, backlog: str):


        self.df = df
        self.df_COD = df['CoD']

        self.original_value_counts = self.df_COD.value_counts()
    ...
    def plot_projection_space(self,save_img_path:Optional[str]=None, save_img:bool=False, dont_show_img:bool=False) -> None:
        ...
        ax.plot(self.df['WOWA_RankExponent_4_24.3_scaled'], np.zeros_like(self.df['WOWA_RankExponent_4_24.3_scaled']), 'ro', markersize=8)
